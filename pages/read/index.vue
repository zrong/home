  ...
  <div id="main-article">
    ...
    >
      <div class="media-left">
        <h3 class="media-left title is-3">
          {{ rt.title }}
        </h3>
      </div>
  ...
  data () {
    return {
      readingList: [
        ...
        {title: 2019, plan: 50, read: 300, note: 0, text: read2019, show: false},
        ...
        {title: 2015, plan: 30, read: 32, note: 5, text: read2015, show: false}
      ]
    }
  },
  created () {
